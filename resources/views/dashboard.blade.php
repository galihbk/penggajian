            ...
            <div class="card radius-10">
                <div class="card-body">
                    ...
                    <div class="chart-container-1">
                        ...
                        <canvas id="chart1" width="569" height="260"
                            style="display: block; width: 569px; height: 260px;"
            ...
            <div class="card radius-10">
                <div class="card-body">
                    ...
                    <div class="chart-container-2 mt-4">
                        ...
                        <canvas id="chart2" width="257" height="220"
                            style="display: block; width: 257px; height: 220px;"
                            class="chartjs-render-monitor"></canvas>
                    </div>
                </div>
                <ul class="list-group list-group-flush">
                    <li class="list-group-item d-flex bg-transparent justify-content-between align-items-center">Jeans
